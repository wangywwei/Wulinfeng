...
public class CircleProgressBar extends ProgressBar {
    ...
    private static final float DEFAULT_PROGRESS_TEXT_SIZE = 13.0f;
    private static final float DEFAULT_PROGRESS_STROKE_WIDTH = 1.0f;

    private static final String COLOR_FFF2A670 = "#00A0E9";
    private static final String COLOR_FFD3D3D5 = "#d2d2d2";
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width, AppUtils.dip2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size, AppUtils.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, AppUtils.dip2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));
