 ...
 */
public class TuJiDetilsAdapter extends BaseExpandableListAdapter {
    ...
    public TuJiDetilsAdapter(Activity activity, List<PLZixunListBean.DataBean> listData, View.OnClickListener replyToCommentListener, String id) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        if (itemNotes.getIsGodComment()==1){
