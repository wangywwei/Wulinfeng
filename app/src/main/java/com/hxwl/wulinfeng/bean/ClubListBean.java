...
public class ClubListBean {
    ...
    public String getQixia_name() {
        return qixia_name;
    }

    public void setQixia_name(String qixia_name) {
        this.qixia_name = qixia_name;
    }
