...
public class ZiXunDetilsAdapter extends BaseExpandableListAdapter {
    ...
    public ZiXunDetilsAdapter(Activity context, List<PLZixunListBean.DataBean> listData, OnClickListener replyToCommentListener, String id) {
