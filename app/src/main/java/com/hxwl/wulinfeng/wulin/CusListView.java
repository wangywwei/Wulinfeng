...
public class CusListView extends ExpandableListView implements OnScrollListener {
	...
	private ImageView head_progressBar2 ;
	...
	private ImageView loadmore_progress2; // 加载更多进度条
...
//		    }
	...
	private void init(Context context) {
		...
		head_progressBar2 = (ImageView) headView.findViewById(R.id.head_progressBar2);
		...
		loadmore_progress2 = (ImageView) mLoadMoreFooterView.findViewById(R.id.loadmore_progress2);
		...
		if (isLoadMoreable) {
			...
			case MotionEvent.ACTION_DOWN:
				if (isOnBottom && !loadmoreIsRecored) {
					...
					startY = (int) event.getY();
					Log.v(TAG, "在down时候记录当前位置>>>"+isOnBottom+loadmoreIsRecored);
				}
				break;
...
//			mLoadMoreProgress.setVisibility(View.INVISIBLE);
			loadmore_progress2.clearAnimation();
			loadmore_progress2.setVisibility(View.INVISIBLE);
...
//			mLoadMoreProgress.setVisibility(View.INVISIBLE);
			loadmore_progress2.clearAnimation();
			loadmore_progress2.setVisibility(View.INVISIBLE);
			mLoadMoreText.setText("上拉加载");
			break;

		case LOADMORE_REFRESHING:

//			mLoadMoreProgress.setVisibility(View.VISIBLE);
			loadmore_progress2.setVisibility(View.VISIBLE);
			loadmore_progress2.startAnimation(animation);
...
//			mLoadMoreProgress.setVisibility(View.INVISIBLE);
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			head_progressBar2.clearAnimation();
			head_progressBar2.setVisibility(View.GONE);
...
//			progressBar.setVisibility(View.VISIBLE);
			head_progressBar2.setVisibility(View.VISIBLE);
			head_progressBar2.startAnimation(animation);
			arrowImageView.clearAnimation();
...
//			progressBar.setVisibility(View.GONE);
			head_progressBar2.setVisibility(GONE);
			head_progressBar2.clearAnimation();
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(R.drawable.xiala);
			tipsTextview.setText("下拉刷新");
			lastUpdatedTextView.setVisibility(View.VISIBLE);
