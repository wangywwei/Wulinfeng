...
import com.hxwl.common.addialog.anim.AnimSpring;

/**
 * 功能:动画弹出对话框的工具类
 * 作者：zjn on 2017/4/24 11:23
 */
public class AnimDialogUtils {
    ...
    public AnimDialogUtils initView(final View customView) {
        ...
        rootView = LayoutInflater.from(context).inflate(R.layout.ad_anim_dialog_layout, null);
