...
public class SearchZixunAdapter extends RecyclerView.Adapter<SearchZixunAdapter.ViewHolder> {
    private ArrayList<SearchZixunBean.DataBean> list;
    private Context context;


    public SearchZixunAdapter(ArrayList<SearchZixunBean.DataBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.information_look.setText(list.get(position).getViewsTrue()+"看过");
//        if (StringUtils.isBlank(list.get(position).getAuthor())){
//            holder.information_look3.setVisibility(View.GONE);
//            holder.information_look3.setText(list.get(position).getAuthor());
//        }else {
