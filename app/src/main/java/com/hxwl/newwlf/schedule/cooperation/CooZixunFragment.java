...
* ——资讯
* */
public class CooZixunFragment extends BaseFragment {
    private View view;
    private XRecyclerView information_recycle;
    private TextView no_information;
    private CooZixunAdapter informationAdapter;
    private ArrayList<ShengDaiZIxunBean.DataBean> list=new ArrayList<>();
    ...
    private void initData() {
        ...
        OkHttpUtils.post()
                .url(URLS.SCHEDULE_AGENTNEWSLIST)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if (jsonValidator.validate(response)){
                            Gson gson = new Gson();
                            try {
                                ShengDaiZIxunBean bean = gson.fromJson(response, ShengDaiZIxunBean.class);
    ...
    private void initView(View view) {
        ...
        informationAdapter=new CooZixunAdapter(list,getActivity());
