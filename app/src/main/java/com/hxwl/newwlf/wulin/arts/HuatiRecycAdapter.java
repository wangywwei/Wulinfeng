...
public class HuatiRecycAdapter extends RecyclerView.Adapter<HuatiRecycAdapter.ViewHolder> {
    private ArrayList<GenHuatiBean.DataBean.TopicListBean> list;
    ...
    public HuatiRecycAdapter(ArrayList<GenHuatiBean.DataBean.TopicListBean> list, Context context) {
        this.list = list;
