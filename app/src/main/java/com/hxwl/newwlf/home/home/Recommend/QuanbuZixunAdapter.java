...
public class QuanbuZixunAdapter extends RecyclerView.Adapter<QuanbuZixunAdapter.ViewHolder> {
    private ArrayList<ZixunqushiBean.DataBean> list;
    private Context context;


    public QuanbuZixunAdapter(ArrayList<ZixunqushiBean.DataBean> list, Context context) {
        this.list = list;
