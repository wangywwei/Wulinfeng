 ...
 */
public class DuizhengVideoDetilsAdapter extends BaseExpandableListAdapter {
    private Activity context;
    private String id;
    //数据
    private List<DuiZhengPLBean.DataBean> listData;
    ...
    public DuizhengVideoDetilsAdapter(Activity activity, List<DuiZhengPLBean.DataBean> listData, View.OnClickListener replyToCommentListener, String id) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        final DuizhengVideoDetilsAdapter.ViewHolder holder;
        final DuiZhengPLBean.DataBean itemNotes = listData.get(groupPosition);
        if (convertView == null) {
            holder = new DuizhengVideoDetilsAdapter.ViewHolder();
            ...
            holder = (DuizhengVideoDetilsAdapter.ViewHolder) convertView.getTag();
        }
        if(groupPosition == 0){
        ...
        holder.iv_zan.setOnClickListener(new View.OnClickListener() {
            ...
            private void dianZan2(final ImageView view, final DuiZhengPLBean.DataBean itemNotes) {
                OkHttpUtils.post()
                        ...
                        .addParams("favourType","4")    //赞类型 1动态的赞 2资讯评论的赞 3选手留言的赞
            ...
            //点赞
            public void dianZan(final ImageView view, final DuiZhengPLBean.DataBean itemNotes) {
                OkHttpUtils.post()
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        final DuiZhengPLBean.DataBean.ReplyListBean noteComment = listData.get(groupPosition)
                .getReplyList().get(childPosition);
        DuizhengVideoDetilsAdapter.ViewHolder holder = new DuizhengVideoDetilsAdapter.ViewHolder();
