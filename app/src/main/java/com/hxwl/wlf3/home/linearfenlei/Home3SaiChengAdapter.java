...
public class Home3SaiChengAdapter extends RecyclerView.Adapter<Home3SaiChengAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(Home3SaiChengAdapter.ViewHolder holder, final int position) {
        ...
        try {
            result = list.get(position).getResult();
        }catch (Exception e){
        }
        ...
        try {
            holder.home3saishi_name.setText(list.get(position).getWinner());
            if (result==1){
...
* */
        try {
            holder.home3saishi_name1.setText(list.get(position).getWinWay());
            if (result==1){
...
try {
            holder.home3saishi_content.setText(list.get(position).getAgainstName());
}catch (Exception e){
