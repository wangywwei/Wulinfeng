...
//                        vll_content.setText(dataxqBean.getEvent().getIntro());
        ...
        // 活动
//        try {
//            List<Home3Bean.DataBean.SchedulesBean.ActivityListBean> activityList = dataxqBean.getActivityList();
...
//                huoDongLayout.setBxqean(dataxqBean.getActivityList().get(0));
//            }
//        }catch (Exception e){
//        }
