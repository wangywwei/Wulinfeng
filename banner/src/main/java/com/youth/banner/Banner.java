...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.lunbotiao;
    ...
    //标签布局
    private RelativeLayout rlyt_banner_lable,rlyt_banner_lable2;
    //标签内容布局
    private TextView tv_banner_lable,tv_banner_lable2;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.banner_select);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.banner_unselect);
//        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.shape_lable_bg);
//        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.white_radius);
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        rlyt_banner_lable = (RelativeLayout) view.findViewById(R.id.rlyt_banner_lable);
        tv_banner_lable = (TextView)view.findViewById(R.id.tv_banner_lable);

        rlyt_banner_lable2 = (RelativeLayout) view.findViewById(R.id.rlyt_banner_lable2);
        tv_banner_lable2 = (TextView)view.findViewById(R.id.tv_banner_lable2);
     ...
     * @return
     */
    public Banner setBannerLables(List<String> lables) {
        this.mLables = lables;
        return this;
    }
    public Banner setBannerLables2(List<String> lables) {
        this.mLables2 = lables;
        return this;
    }
...
//            titleView.setBackgroundColor(titleBackground);
        ...
        if(mLables != null && mLables.size() > 0 && !isEmpty(mLables.get(0))){
            rlyt_banner_lable.setVisibility(View.VISIBLE);
            tv_banner_lable.setText(mLables.get(0));
            rlyt_banner_lable2.setVisibility(View.VISIBLE);
            tv_banner_lable2.setText(mLables2.get(0));
        }
    }
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(dm.widthPixels/count, 3);
...
//            params.rightMargin = mIndicatorMargin;
    ...
    private void setData() {
        ...
        int qq = viewPager.getChildCount();
       ...
       // Log.e(tag,"----"+position);
        ...
        switch (bannerStyle) {
            ...
            case BannerConfig.NUM_INDICATOR_TITLE:
                ...
                if(!isEmpty(mLables.get(position -1))){
                    rlyt_banner_lable.setVisibility(View.VISIBLE);
                    tv_banner_lable.setText(mLables.get(position-1));
                    rlyt_banner_lable2.setVisibility(View.VISIBLE);
                    tv_banner_lable2.setText(mLables2.get(position-1));
                }else{
                    rlyt_banner_lable.setVisibility(View.GONE);
                    rlyt_banner_lable2.setVisibility(View.GONE);
                }
                break;
            case BannerConfig.CIRCLE_INDICATOR_TITLE:
                bannerTitle.setText(titles.get(position - 1));
